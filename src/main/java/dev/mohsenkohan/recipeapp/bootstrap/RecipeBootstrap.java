package dev.mohsenkohan.recipeapp.bootstrap;

import dev.mohsenkohan.recipeapp.domain.*;
...
public class RecipeBootstrap implements CommandLineRunner {
    ...
    private List<Recipe> createRecipes() {
        ...
        // gets UnitOfMeasures
        UnitOfMeasure each = unitOfMeasureRepository.findByDescription("Each").orElseThrow();
        ...
        UnitOfMeasure dash = unitOfMeasureRepository.findByDescription("Dash").orElseThrow();
        ...
        guacRecipe.addCategory(italian);
        guacRecipe.addCategory(fastFood);

        recipes.add(guacRecipe);

        // makes yummy taco recipe
        ...
        tacosRecipe.addCategory(fastFood);
